...
4. Render the HTML part of the output with the inline widget tool (`show_widget`), title `stretch_<id>`, one loading message. If the widget tool is not available, give the name, the cue, and the steps as a short numbered list.
